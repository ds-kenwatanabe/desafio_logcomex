...
Além disso para as perguntas específicas, foi feito um script a fim de respondê-las.
O arquivo `reports/reports.md` detalha as respostas do desafio e o processo de desenvolvimento do modelo.
